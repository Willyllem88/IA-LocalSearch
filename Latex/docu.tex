...
\begin{document}
	...
	Aquesta funció no té en compte la maximització de la felicitat dels clients ni la reducció de costos. Simplement, envia els paquets el dia esperat, assignant-los a una oferta que coincideixi exactament amb la data d'entrega especificada. La idea principal és buscar una oferta que compleixi amb aquesta condició i tingui espai suficient per al paquet. Per tant, es pot resumir així: \\
