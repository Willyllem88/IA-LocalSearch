	...
	\begin{table}[ht]
		...
		\begin{tabular}{|l|p{10cm}|}
			...
			\begin{itemize}
				...
				\item Executarem un experiment amb l'operador \textit{swap} per cada llavor.
				\item Executarem un experiment amb els operadors \textit{move} i \textit{swap} per cada llavor.
			\end{itemize} \\
			\hline
		\end{tabular}
		\label{tab:apartats}
